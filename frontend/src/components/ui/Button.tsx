...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  secondary:
    'bg-foreground text-canvas hover:bg-foreground/90 disabled:hover:bg-foreground',
  outline:
    'border border-border bg-transparent text-foreground hover:bg-surface-hover disabled:hover:bg-transparent',
  ghost:
    'bg-transparent text-brand hover:bg-brand-soft disabled:hover:bg-transparent',
